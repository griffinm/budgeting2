...
private val PremiumDarkColorScheme = darkColorScheme(
    ...
    primaryContainer = DarkSurfaceBright,
    onPrimaryContainer = AccentCyan,
    secondary = AccentPurple,
    onSecondary = DarkBackground,
    secondaryContainer = DarkSurfaceBright,
    onSecondaryContainer = AccentPurple,
    tertiary = AccentGold,
    onTertiary = DarkBackground,
    tertiaryContainer = DarkSurfaceBright,
    onTertiaryContainer = AccentGold,
    error = PremiumRed,
    onError = DarkBackground,
    errorContainer = DarkSurfaceElevated,
    onErrorContainer = PremiumRed,
